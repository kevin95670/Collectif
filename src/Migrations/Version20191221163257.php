 ...
 */
final class Version20191221163257 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE events (id INT AUTO_INCREMENT NOT NULL, id_createur_id INT NOT NULL, name VARCHAR(255) NOT NULL, date DATETIME NOT NULL, category VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, nb_participant INT DEFAULT NULL, url_image VARCHAR(255) DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, INDEX IDX_5387574A6BB0CC12 (id_createur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
